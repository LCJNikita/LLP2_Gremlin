...
// g.V.as(12).out().has(name,"Mike",=).or().not().as(321).new().value(name,"Roma").rel(12)

void print_view(struct view *view){
    char *op;
    switch (view->op) {
        case CRUD_NEW: op = "NEW"; break;
        case CRUD_UPDATE: op = "UPDATE"; break;
        case CRUD_REMOVE: op = "REMOVE"; break;
        case CRUD_GET: op = "GET"; break;
            ...
            while (condition != NULL) {
                ...
                if (condition->is_id) {
                    ...
                    switch (condition->op) {
                        ...
                        case OP_NOT_LESS: op = ">="; break;
                        case OP_NOT_GREATER: op = "<="; break;
                        case OP_SUBSTR: op = "substring"; break;
                        default: op = "NULL"; break;
                    }
